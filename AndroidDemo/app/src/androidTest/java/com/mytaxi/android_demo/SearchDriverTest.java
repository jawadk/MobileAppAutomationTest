...
import com.mytaxi.android_demo.common.Common;
...
public class SearchDriverTest {
    ...
    public void setUp() throws Exception {
        ...
        /*Get the user credentials from API */
        Map<String, String> user = Common.getUserCredential();

        /*Login Activity - Type username, password and click sign-in btn*/
        ...
        Log.i(LOG_TAG, "User is logged in successfully...!!!");
    ...
    public void searchDriver() throws Exception {
        ...
        /*Press Back button to navigate on Main Activity screen*/
        pressBack();
